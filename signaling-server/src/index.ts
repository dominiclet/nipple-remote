...
// Utility functions
function makeRemoteId(length: number) {
    var result           = '';
...
// Devices mapping
let remotesIdToWs = new Map<string, Socket>();
let remotesWsToId = new Map<Socket, string>();

let idToWs = new Map<string, Socket>();
let wsToId = new Map<Socket, string>();
